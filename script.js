...
// أسئلة اللعبة: 100 سؤال لكل مستوى بالعربية
const questionBank = {
  easy: [
    {q:"ص = جاس(س)", a:"جتاس(س)"},
    {q:"ص = جتا(س)", a:"-جتاس(س)"},
    ...
    // … أضف باقي أسئلة المستوى السهل حتى 100
  ],
  medium: [
    ...
    // … أضف باقي أسئلة المستوى المتوسط حتى 100
  ],
  hard: [
    ...
    // … أضف باقي أسئلة المستوى الصعب حتى 100
  ]
};
